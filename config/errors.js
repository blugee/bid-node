...
module.exports = {
    errors: {
        ...
        LINE_ITEM_ADDED_SUCCESSFULLY: {
            response_code: "E_SUCCESS",
            message: 'Line Item is successfully added',
            status: 200
        },
        ...
        BID_UPDATED_SUCESSFULLY: {
            response_code: "E_SUCESS",
            message: 'Bid Updated Sucessfully',
            status: 200
        },

        ITEM_UPDATED_SUCESSFULLY: {
            response_code: "E_SUCESS",
            message: 'Item Updated Sucessfully',
            status: 200
        },

        LINE_ITEM_UPDATED_SUCESSFULLY: {
            response_code: "E_SUCESS",
            message: 'Line Item Updated Sucessfully',
            status: 200
        },

        CUSTOMER_UPDATED_SUCESSFULLY: {
            response_code: "E_SUCESS",
        ...
        FORGOT_EMAIL_SEND_FAILURE: {
            ...
            message: 'No users with this email address.',
            status: 200
        },
        ...
        ERROR_INSERT_USER: {
            ...
            message: 'Error occured in inserting users, please try again later.',
            status: 500
        },
        ...
        ERROR_USER_VERIFICATION: {
            ...
            message: 'Something went wrong during users verification, please try again later.',
            status: 602
        },
        ...
        ERROR_PUSH_NOTIFICATION: {
            ...
            message: 'Something went wrong to send notification to nearer users.',
            status: 604
        },
